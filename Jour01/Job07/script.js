...
function jourtravaille(date){
    ...
    if(date.getDay() == 0 || date.getDay() == 6){
        var monthvalue = date.getMonth();
        console.log('Non, '+date.getDate()+" "+monthname[monthvalue]+" "+date.getFullYear()+" est un week-end");
    }else{
        var monthvalue = date.getMonth();
        console.log('oui, '+date.getDate()+" "+monthname[monthvalue]+" "+date.getFullYear()+" est un jour travailler");
    }
}
